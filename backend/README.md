...
## Project Structure
    ...
    ├── testapiautoconnecto_75412  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_75412`
...
2. Clone this repo and `cd testapiautoconnecto_75412`
